...
namespace WebExpress.WebApp.WebFragment
{
    ...
    /// </summary>
    public abstract class FragmentControlDataWorkflow : ControlDataWorkflow, IFragmentControl<ControlDataWorkflow>
    {
        /// <summary>
        ...
        public FragmentControlDataWorkflow(IFragmentContext fragmentContext)
