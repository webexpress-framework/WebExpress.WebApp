...
namespace WebExpress.WebApp.WebFragment
{
    ...
    /// </summary>
    public abstract class FragmentControlDataFormDelete : ControlDataFormDelete, IFragmentControl<ControlDataFormDelete>
    {
        /// <summary>
        ...
        /// Id will be used.
        /// </param>
        public FragmentControlDataFormDelete(IFragmentContext fragmentContext, string id = null)
