...
namespace WebExpress.WebApp.WebMessageQueue
{
    ...
    {
        /// <summary>
        /// Gets or sets the request method (e.g. POST).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the options from the header.
        /// </summary>
        public RequestHeaderFields Header { get; set; }

        /// <summary>
        /// Gets or sets the ip address and port number of the client from which the request originated.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the collection of parameters associated with the request.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the associated plugin context.
        /// </summary>
        public IPluginContext PluginContext { get; set; }

        /// <summary>
        /// Gets or sets the corresponding application context.
        /// </summary>
        public IApplicationContext ApplicationContext { get; set; }

        /// <summary>
        /// Gets or sets the collection of domain names associated with the current context.
        /// </summary>
