...
namespace WebExpress.WebApp.WebControl
{
    ...
    /// </summary>
    public class ControlDataDashboard : ControlPanel, IControlDataDashboard, IDataIsland, IScopeBound
    {
        /// <summary>
        /// Gets or sets the name of the enclosing scope resource the dashboard
