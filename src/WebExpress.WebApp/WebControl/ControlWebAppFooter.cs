...
namespace WebExpress.WebApp.WebControl
{
    ...
    public class ControlWebAppFooter : Control, IControlWebAppFooter
    {
        ...
        public IControlWebAppFooter AddPreferences(params IControl[] items)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlWebAppFooter RemovePreference(IControl item)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlWebAppFooter AddPrimary(params IControl[] items)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlWebAppFooter RemovePrimary(IControl item)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlWebAppFooter AddSecondary(params IControl[] items)
        {
        ...
        /// <returns>The current instance for method chaining.</returns>
        public IControlWebAppFooter RemoveSecondary(IControl item)
        {
