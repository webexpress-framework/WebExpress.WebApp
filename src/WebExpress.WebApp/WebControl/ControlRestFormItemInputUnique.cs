...
namespace WebExpress.WebApp.WebApiControl
{
    ...
    public class ControlRestFormItemInputUnique : ControlFormItemInput<ControlFormInputValueString>
    {
        ...
        /// </param>
        /// <param name="file">
        /// The file path of the source file where this instance is created. This is automatically provided by the compiler.
        /// </param>
        /// <param name="line">
        /// The line number in the source file where this instance is created. This is automatically provided by the compiler.
        /// </param>
        ...
        (
            ...
            : base($"unique_{instance}_{file}_{line}".GetHashCode().ToString("X"))
        {
        }
