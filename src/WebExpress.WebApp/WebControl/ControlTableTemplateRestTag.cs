...
{
    /// <summary>
    /// Represents a control that renders free-text tags in a table using a
    /// template. The read-only cell shows the tags of the value (a tag is its own
    /// label, so no service is needed); the editable cell offers a tag input whose
    /// autocomplete suggestions are served by a REST endpoint via the <c>q</c>
    /// query parameter.
    /// </summary>
    public class ControlTableTemplateRestTag : IControlTableTemplateEditable, IDataIsland
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the placeholder text displayed when the tag input is empty.
        /// </summary>
        ...
        /// resolves into the template's endpoint parameter (the autocomplete
        /// source); the table builds a client side wx-service island when it
        /// materializes the cells.
        /// </summary>
        ...
        public ControlTableTemplateRestTag(string id = null)
        {
            Id = id;
        }
        ...
        public virtual IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree)
        {
            ...
            return new HtmlElement("template")
            {
                ...
                .AddUserAttribute("data-type", "rest_tag")
