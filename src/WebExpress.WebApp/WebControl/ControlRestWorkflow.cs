...
namespace WebExpress.WebApp.WebControl
{
    ...
    /// </summary>
    public class ControlRestWorkflow : ControlPanel, IControlRestWorkflow
    {
        /// <summary>
        ...
        public ControlRestWorkflow(string id = null)
        ...
        public virtual IHtmlNode Render(IRenderControlContext renderContext, IVisualTreeControl visualTree, IUri uri)
        {
            ...
            {
                Id = Id,
                Class = Css.Concatenate("wx-webapp-workflow-editor", GetClasses()),
                Style = GetStyles()
            }
