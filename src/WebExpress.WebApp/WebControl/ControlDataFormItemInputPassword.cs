...
namespace WebExpress.WebApp.WebApiControl
{
    ...
    /// </summary>
    public class ControlDataFormItemInputPassword : ControlFormItemInputPassword
    {
        /// <summary>
        /// Initializes a new instance of the class with an automatically assigned ID.
        /// </summary>
        public ControlDataFormItemInputPassword()
        ...
        public ControlDataFormItemInputPassword(string id)
            : base(id)
        {
        }
