...
namespace WebExpress.WebApp.WebControl
{
    ...
    /// </summary>
    public interface IControlDataTabTemplate : IWebUIElement<IRenderControlContext, IVisualTreeControl>
    {
        /// <summary>
        ...
        IControlDataTabTemplate Add(params IControl[] items);
        ...
        /// <param name="items">The items to add.</param>
        /// <returns>The current instance for method chaining.</returns>
        IControlDataTabTemplate Add(IEnumerable<IControl> items);
        ...
        /// <returns>The current instance for method chaining.</returns>
        IControlDataTabTemplate Remove(IControl item);
    }
}
