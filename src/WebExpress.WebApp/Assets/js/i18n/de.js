...
webexpress.webui.I18N.register("de", "webexpress.webapp", {
    ...
    "search.suggestion.empty": "Keine Treffer gefunden.",
    ...
    "gantt.scale.month": "Monat",
    "gantt.zoom_in": "Vergrößern",
    "gantt.zoom_out": "Verkleinern",
    "gantt.today": "Heute",
    "gantt.week_short": "KW ",
    "gantt.days_short": "T",
    "gantt.col.name": "Aufgabe",
    "gantt.col.start": "Start",
    "gantt.col.end": "Ende",
    "gantt.col.duration": "Dauer",
    "gantt.col.progress": "Fortschritt",
    "gantt.col.resources": "Ressourcen",
    "gantt.delete_task": "Aufgabe löschen",
    "gantt.toggle_grid": "Aufgabenliste ein-/ausblenden",
    "gantt.empty": "Noch keine Aufgaben. Über „Neue Aufgabe“ oder per Doppelklick in die Zeitachse anlegen.",
    "gantt.load_failed": "Der Plan konnte nicht geladen werden.",
    "gantt.retry": "Erneut versuchen",
    ...
    "scrum.menu.assign": "Zuweisen & schätzen…",
    "scrum.dialog.assign_estimate": "Zuweisen & schätzen",
    "scrum.field.assignee": "Zugewiesen an",
    "scrum.field.points": "Story Points",
    "scrum.assignee.unassigned": "Nicht zugewiesen",
    "scrum.assignee.search": "Personen suchen…",
    ...
    // link surface: the relations of one object
    "relation.title": "Verknüpfungen",
    "relation.add": "Verknüpfung",
    "relation.view.list": "Liste",
    "relation.view.graph": "Graph",
    "relation.counterpart": "Gegenstück: {0}",
    "relation.empty": "Noch keine Verknüpfungen",
    "relation.detail": "Details",
    "relation.detail.target": "Verknüpftes Objekt",
    "relation.detail.status": "Status",
    "relation.detail.since": "Verknüpft",
    "relation.note.empty": "Keine Notiz an dieser Verknüpfung.",
    "relation.reactivate": "Wieder aktivieren",
    "relation.navigate": "Navigieren zu",
    "relation.remove": "Verknüpfung entfernen",
    "relation.since": "seit {0}",
    "relation.error.create": "Die Verknüpfung konnte nicht angelegt werden.",

    // dialog that establishes a link
    "relation.dialog.title": "Verknüpfung hinzufügen",
    "relation.system.object": "Objekt",
    "relation.system.web": "Webseite",
    "relation.dialog.section.native": "Anwendung",
    "relation.dialog.section.plugins": "Plugins",
    "relation.dialog.plugin": "Plugin",
    "relation.dialog.disabled": "deaktiviert",
    "relation.dialog.kind.object": "Objekt ↔ Objekt",
    "relation.dialog.kind.external": "externe Adresse",
    "relation.dialog.no.panel": "Dieses Linksystem stellt keine Eingabemaske bereit.",
    "relation.dialog.submit": "Verknüpfen",
    "relation.dialog.pick.target": "Ziel wählen",
    "relation.dialog.type": "Verknüpfungstyp",
    "relation.dialog.type.required": "Bitte wählen Sie einen Verknüpfungstyp.",
    "relation.dialog.search": "Ziel suchen",
    "relation.dialog.search.placeholder": "Objekt suchen — Schlüssel, Titel oder Klasse …",
    "relation.dialog.type.placeholder": "Verknüpfungstyp wählen",
    "relation.dialog.no.matches": "Keine Treffer",
    "relation.dialog.target.required": "Bitte wählen Sie das Zielobjekt aus.",
    "relation.dialog.note": "Notiz am Link",
    "relation.dialog.note.placeholder": "Warum gehören die beiden zusammen?",
    "relation.dialog.address": "Adresse",
    "relation.dialog.address.title": "Titel",
    "relation.dialog.address.title.placeholder": "Wie soll die Adresse angezeigt werden?",
    "relation.dialog.address.invalid": "Bitte geben Sie eine Adresse an, die mit http:// oder https:// beginnt.",

    // administration of the relation types
    "relation.type.title": "Verknüpfungstypen",
    "relation.type.title.class": "Verknüpfungstypen der Klasse {0}",
    "relation.type.counts": "{0} aktiv · {1} definiert",
    "relation.type.new": "Typ anlegen",
    "relation.type.edit": "Verknüpfungstyp bearbeiten",
    "relation.type.remove": "Verknüpfungstyp löschen",
    "relation.type.symmetric": "symmetrisch",
    "relation.type.all.classes": "alle Typen",
    "relation.type.column.relation": "Relation",
    "relation.type.column.target": "Zieltyp",
    ...
    "relation.effect.closes": "Schließt Vorgang",
    "relation.effect.aggregates": "Aggregiert Fortschritt",

    // editor of one relation type
    "relation.type.dialog.title": "Verknüpfungstyp bearbeiten",
    "relation.type.dialog.label": "Bezeichnung — aus Sicht dieses Vorgangs",
    "relation.type.dialog.label.hint": "So erscheint der Typ auf dem Vorgang, von dem die Verknüpfung angelegt wird.",
    "relation.type.dialog.inverse": "Gegenstück — aus Sicht des Zielobjekts",
    "relation.type.dialog.symmetric": "Symmetrisch — beide Seiten gleich benannt",
    "relation.type.dialog.classes": "Zieltyp",
    "relation.type.dialog.cardinality": "Kardinalität",
    "relation.type.dialog.effect": "Wirkung",
    "relation.type.dialog.description": "Beschreibung für Nutzer",
    "relation.type.dialog.preview": "Vorschau in der Objektansicht",
    "relation.type.dialog.any": "beliebiges Objekt",
    "relation.type.dialog.impact": "{0} bestehende Verknüpfungen betroffen",
    "relation.type.dialog.submit": "Änderungen übernehmen",
    "relation.type.label.required": "Bitte benennen Sie die Beziehung.",
    "relation.type.inverse.required": "Bitte benennen Sie das Gegenstück oder markieren Sie die Beziehung als symmetrisch.",
    "relation.type.classes.required": "Bitte wählen Sie mindestens einen Zieltyp.",

    // reasons the server rejected a link or a link type
    "relation.unknown.source": "Der Ausgangsvorgang der Verknüpfung existiert nicht.",
    "relation.unknown.target": "Der Zielvorgang der Verknüpfung existiert nicht.",
    "relation.unknown.system": "Das angegebene Linksystem ist nicht registriert.",
    "relation.unknown.type": "Der angegebene Verknüpfungstyp ist nicht registriert.",
    "relation.disabled.system": "Das angegebene Linksystem ist deaktiviert.",
    "relation.inactive.type": "Der angegebene Verknüpfungstyp ist deaktiviert.",
    "relation.type.system.mismatch": "Der Verknüpfungstyp wird von diesem Linksystem nicht angeboten.",
    "relation.target.class": "Der Verknüpfungstyp lässt diese Zielklasse nicht zu.",
    "relation.self": "Ein Vorgang kann nicht mit sich selbst verknüpft werden.",
    "relation.duplicate": "Diese Verknüpfung besteht bereits.",
