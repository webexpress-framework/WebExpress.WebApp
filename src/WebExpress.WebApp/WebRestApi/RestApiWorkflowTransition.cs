...
namespace WebExpress.WebApp.WebRestApi
{
    ...
    public class RestApiWorkflowTransition
    {
        ...
        /// <summary>
        /// Gets or sets the recipient address for the message.
        /// </summary>
        [JsonPropertyName("to")]
        ...
        /// <summary>
        /// Gets or sets the dash pattern used for rendering lines.
        /// </summary>
        [JsonPropertyName("dasharray")]
        public string DashArray { get; set; }

        /// <summary>
        /// Gets or sets the collection of waypoints that define the workflow sequence.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the form associated with the current object.
        /// </summary>
        [JsonPropertyName("form")]
        public string Form { get; set; }

        /// <summary>
        /// Gets or sets the collection of workflow guards that define conditions for workflow execution.
        /// </summary>
        [JsonPropertyName("guards")]
        public IEnumerable<RestApiWorkflowGuard> Guards { get; set; }

        /// <summary>
        /// Gets or sets the collection of validators associated with the workflow.
        /// </summary>
