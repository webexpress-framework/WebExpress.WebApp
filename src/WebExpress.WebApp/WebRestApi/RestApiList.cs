...
namespace WebExpress.WebApp.WebRestApi
{
        ...
        where TIndexItem : IIndexItem
    {
        ...
        /// </returns>
        protected abstract IEnumerable<RestApiListItem> RetrieveItems(IQuery<TIndexItem> query, IQueryContext context, IRequest request);

        /// <summary>
        /// Returns how many items the filtered result holds in total, before paging narrows it.
        /// </summary>
        /// <remarks>
        ...
        /// <see cref="RetrieveItems"/> a second time, which is a price no endpoint should pay
        /// without asking.
        /// </remarks>
        /// <param name="query">
        /// The filtered query, without paging applied.
        /// </param>
        /// <param name="context">
        ...
        /// </param>
        /// <returns>
        /// The number of items in the whole result, or a negative value when the endpoint does
        /// not count it.
        /// </returns>
