...
{
    /// <summary>
    /// Represents the result of a REST API operation that retrieves quickfilters.
    /// </summary>
    /// <typeparam name="TIndexItem">The type of the items in the quickfilter.</typeparam>
    public class RestApiQuickfilterResult<TIndexItem> : IRestApiResult
