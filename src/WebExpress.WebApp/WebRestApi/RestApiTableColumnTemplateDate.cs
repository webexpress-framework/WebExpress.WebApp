...
{
    /// <summary>
    /// Represents a table column template of type "date" for REST API table
    /// rendering, providing configuration options such as the date format,
    /// color and placeholder text.
    /// </summary>
    public class RestApiTableColumnTemplateDate : RestApiTableColumnTemplate
    {
        /// <summary>
        ...
        /// </param>
        public RestApiTableColumnTemplateDate(bool editable = false, string format = "yyyy-MM-dd", TypeColorText color = TypeColorText.Default, string placeholder = null)
        {
            Editable = editable;
            Format = format;
            Color = color;
        ...
        /// <summary>
        /// Collects the options the client-side date renderer reads.
        /// </summary>
