...
{
    /// <summary>
    /// Ensures that a collection contains at least the specified number of items.
    /// </summary>
    [AttributeUsage(AttributeTargets.Property)]
    public sealed class ValidateMinItemsAttribute : Attribute, IValidation
    {
        /// <summary> 
        /// Returns the minimum required number of items in the collection. 
        /// </summary>
        ...
        /// </summary>
        /// <param name="count">The minimum required number of items.</param>
        /// <param name="message">
        /// The error message that will be returned when validation fails.
        /// </param>
        public ValidateMinItemsAttribute(int count, string message = null)
        {
            Count = count;
            Message = message ?? "webexpress.webapp:validation.minitems";
        }
