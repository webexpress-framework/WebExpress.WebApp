...
{
    /// <summary>
    /// A typed, C# authored description of a named resource of a scope ViewState.
    /// A resource binds a slice of the scope state to a named service: it names
    ...
    /// consumes, so the scope loads the resource centrally and every control that
    ...
    /// scope model by hosting it in a ControlViewState that declares the state,
    ...
    public class DataResourceDescriptor
    {
        ...
        /// <summary>
        /// Gets or sets the name of the scope service that loads the resource.
        /// </summary>
        ...
        /// <summary>
        /// Gets the parameters of the resource. Each parameter binds a scope state
    ...
    /// <summary>
    /// A single bidirectional binding between a scope state key and a query
    ...
    public class DataResourceParam
    {
        ...
        /// <summary>
        /// Gets the scope state key the parameter binds to.
        /// </summary>
        ...
        /// </summary>
        /// <param name="name">The logical query parameter name.</param>
        /// <param name="state">The scope state key.</param>
