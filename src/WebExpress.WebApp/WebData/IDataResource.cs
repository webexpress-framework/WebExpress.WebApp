...
{
    /// <summary>
    /// Marks a type as the identity of a scope resource. A resource type names a
    /// central resource of a scope ViewState in a type-safe way, replacing the
    /// string resource name: the scope declares the resource with
