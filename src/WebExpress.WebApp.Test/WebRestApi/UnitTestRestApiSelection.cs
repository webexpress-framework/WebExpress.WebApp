...
{
    /// <summary>
    /// Provides unit tests for verifying the behavior of the RestApiSelection class.
    /// </summary>
    [Collection("NonParallelTests")]
    public class UnitTestRestApiSelection
    {
        /// <summary>
        ...
        public void Retrieve()
        {
            ...
            var selection = new TestRestApiSelection([item]);
            var request = UnitTestControlFixture.CreateRequestMock();

            // act
            var result = selection.Retrieve(request);
