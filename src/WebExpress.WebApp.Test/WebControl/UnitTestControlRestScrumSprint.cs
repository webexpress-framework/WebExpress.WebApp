...
namespace WebExpress.WebApp.Test.WebControl
{
    ...
    public class UnitTestControlRestScrumSprint
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlRestScrumSprint(id)
            {
            };
        ...
        [Theory]
        [InlineData(null, @"<div id=""*"" class=""wx-webapp-scrum-sprint""></div>")]
        [InlineData("https://example.com/api/scrum/sprint", @"<div id=""*"" class=""wx-webapp-scrum-sprint"" data-rest-uri=""https://example.com/api/scrum/sprint""></div>")]
        public void RestUri(string uriString, string expected)
        {
            ...
            var context = UnitTestControlFixture.CreateRenderContextMock(application);
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlRestScrumSprint()
            {
