...
namespace WebExpress.WebApp.Test.WebControl
{
    ...
    public class UnitTestControlDataFormItemInputPassword
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlDataFormItemInputPassword(id)
            {
            };
        ...
        public void AutoId(string expected)
        {
            ...
            var context = new RenderControlFormContext(UnitTestControlFixture.CreateRenderContextMock(), form);
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlDataFormItemInputPassword()
            {
            };
        ...
        public void Name(string name, string expected)
        {
            ...
            var context = new RenderControlFormContext(UnitTestControlFixture.CreateRenderContextMock(), form);
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlDataFormItemInputPassword(null)
            {
                Name = _ => name
            };
        ...
        public void ValidateForm(string value, string expected)
        {
            ...
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlDataFormItemInputPassword("password-box").Initialize(args =>
            {
        ...
        public void ProcessForm(string value, string expected)
        {
            ...
            var visualTree = new VisualTreeControl(componentHub, context.PageContext);
            var control = new ControlDataFormItemInputPassword("password-box")
                .Initialize(args =>
                {
                    args.Value.Text = value;
                });
