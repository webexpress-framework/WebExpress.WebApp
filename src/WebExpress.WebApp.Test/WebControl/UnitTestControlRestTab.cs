...
namespace WebExpress.WebApp.Test.WebControl
{
    ...
    public class UnitTestControlRestTab
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlRestTab(id)
            {
            };
        ...
        /// <summary>
        /// Tests the RestUri property of the api tab control.
        /// </summary>
        [Theory]
        [InlineData(null, @"<div id=""*"" class=""wx-webapp-tab""></div>")]
        [InlineData("https://example.com/api/data", @"<div id=""*"" class=""wx-webapp-tab"" data-uri=""https://example.com/api/data""></div>")]
