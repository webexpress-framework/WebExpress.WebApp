...
namespace WebExpress.WebApp.Test.WebControl
{
    ...
    public class UnitTestControlWebAppHeaderAppNavigator
    {
        ...
        /// </summary>
        [Theory]
        [InlineData(null, @"<div class=""wx-webui-dropdown wx-appnavigator"" title=""TestApplication"" data-image=""/server/app/assets/img/Logo.png""><div class=""wx-dropdown-header"" role=""heading"">TestApplication</div><div id=""webexpress-webapp-test-testfragmentsectionapppreferencesitem"" class=""wx-dropdown-item"">TestFragmentSectionAppPreferencesItem</div></div>")]
