...
namespace WebExpress.WebApp.Test.WebControl
{
    ...
    public class UnitTestControlRestList
    {
        /// <summary>
        ...
        public void Id(string id, string expected)
        {
            ...
            var control = new ControlRestList(id)
            {
            };
        ...
        [Theory]
        [InlineData(null, @"<div id=""*"" class=""wx-webapp-list""></div>")]
        [InlineData("https://example.com/api/data", @"<div id=""*"" class=""wx-webapp-list"" data-uri=""https://example.com/api/data""></div>")]
